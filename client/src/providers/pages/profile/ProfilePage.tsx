...
import { imageValidation, validatePersonalFields } from "../../../utils/ValidationHelper";
...
const ProfilePage = ({ userType }: profileProp) => {
  ...
  return (
    <ProviderLayout>
      <div className="bg-[#f2f2f9] rounded-lg p-6">
        {showPasswordPopup&&
        <ProviderChangePassword close={closePopup}/>
        }
        ...
        <div className="bg-[#9796DE] p-6 rounded-xl shadow-md space-y-6">
          ...
          <div className="flex justify-between items-center text-white">
            ...
            <div className="space-x-2">
              ...
              <button onClick={showPassordPopup} className="bg-white text-[#5A52A4] px-4 py-1 rounded-full text-sm font-semibold shadow">
                CHANGE PASSWORD
              </button>
