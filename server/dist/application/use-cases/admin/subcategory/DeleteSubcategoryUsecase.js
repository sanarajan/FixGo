...
exports.DeleteSubcategoryUsecase = void 0;
const tsyringe_1 = require("tsyringe");
let DeleteSubcategoryUsecase = class DeleteSubcategoryUsecase {
    constructor(repo) {
        this.repo = repo;
    }
    async execute(id) {
...
exports.DeleteSubcategoryUsecase = DeleteSubcategoryUsecase = __decorate([
    (0, tsyringe_1.injectable)(),
    __param(0, (0, tsyringe_1.inject)("IServiceRepository")),
    __metadata("design:paramtypes", [Object])
], DeleteSubcategoryUsecase);
//# sourceMappingURL=DeleteSubcategoryUsecase.js.map