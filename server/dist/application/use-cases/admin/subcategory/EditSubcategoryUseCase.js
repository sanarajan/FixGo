...
exports.EditSubcategoryUseCase = void 0;
const tsyringe_1 = require("tsyringe");
let EditSubcategoryUseCase = class EditSubcategoryUseCase {
    constructor(repo) {
        this.repo = repo;
    }
    async execute(admin, id, data) {
        ...
        if (!current) {
            const err = new Error("Subcategory not exist");
            err.status = 404;
            throw err;
        }
...
exports.EditSubcategoryUseCase = EditSubcategoryUseCase;
exports.EditSubcategoryUseCase = EditSubcategoryUseCase = __decorate([
    (0, tsyringe_1.injectable)(),
    __param(0, (0, tsyringe_1.inject)("IServiceRepository")),
    __metadata("design:paramtypes", [Object])
], EditSubcategoryUseCase);
//# sourceMappingURL=EditSubcategoryUseCase.js.map